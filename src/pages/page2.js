...
const result =["aave-amm","aave-safety-module","aave-v1","aave-v2","aave-v3","aavegotchi","abracadabra","adamant","alchemix","alkemi","alpha-tokenomics","alpha-v1","alpha-v2","apeswap","apy","arcx","armor","augur","autofarm","b-protocol","badger","balancer-v1","balancer-v2","bancor","bao","barnbridge","barnbridge-smart-yield","beefy","beethoven-x","belt","benqi","bent","blizz","compound","convex","cream","cryptex","curve","defi-kingdoms","defi-swap","defisaver","derivadex","deversifi","dforce","dfyn","dhedge","dinoswap","dodo","dopex","dydx","88mph","88mph-v3","element","ellipsis","epns","fei","float-capital","float-protocol","floor-dao","frax","gamma-strategies","geist","gmx","governor-dao","grim","harvest","hector-dao","hegic","hop","hundred-finance","idle","illuvium","index-coop","indexed","inverse","iron","iron-bank","jones-dao","keep-network","keeper-dao","klima","klondike","kogefarm","kyber-dmm","llama-airforce","looks-rare","loopring","lydia","lyra","maker","maple","mirror","mooniswap","morpheus-swap","mstable","naos","nexus-mutual","nft20","nftx","notional-finance","nsure-network","olympus","ondo","1inch","onx","opium-network","opyn","origin","orion-protocol","otterclam","pancakeswap","pangolin","penguin","perpetual-protocol","pickle","platypus-finance","polywhale","pool-together","pooltogether-v4","popsicle","powerpool","premia","qi-dao","quickswap","r-u-generous","railgun","rari","rari-fuse","realt","reaper","redacted-cartel","reflexer","ribbon","ribbon-v2","sablier","saddle","scarecrow","scream","shapeshift","shell","smoothy","snowball","snowbank","snowdog","snowswap","solarbeam","solidex","solidly","spartacus","spiritswap","spookyswap","squid","stake-dao","stargate","stormswap","superfluid","sushiswap","sushiswap-bentobox","sushiswap-kashi","swapr","swerve","synapse","synlev","tarot","the-graph","tokenlon","tomb","tornado-cash","trader-joe","truefi","ubeswap","uniswap-v1","uniswap-v2","uniswap-v3","unit","universe","venus","vesper","vesta-finance","waultswap","wepiggy","wonderland","xsigma","yam","yaxis","yearn","zlot","synthetix","aelin","enzyme-finance","liquity","pie-dao","teddy-cash","tokemak","unagii"]
